...
describe('ApiService', () => {
    ...
    beforeAll(async () => {
        const module: TestingModule = await Test.createTestingModule({providers: [ApiService]}).compile();
    ...
    describe('evaluateExpression', () => {
        ...
        describe('Valid expressions evaluations', () => {
            ...
            it('The result of sin(30) + cos(20) is -0.5799495622794699', () => {
                expect(apiService.evaluateExpression('sin(30)+cos(20)')).toEqual(-0.5799495622794699);
            });
        });
