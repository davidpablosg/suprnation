...
class App extends React.Component {
    ...
    handleSubmit = expression => {
        this.setState({evaluatedExpressions: [expression, ...this.state.evaluatedExpressions]});
        if (this.state.evaluatedExpressions.length > 4) this.state.evaluatedExpressions.pop();
    }
